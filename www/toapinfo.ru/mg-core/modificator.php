...
class DatoBaseUpdater {
	...
	public static function updateDbVer() {
		...
		DB::query("DELETE FROM `".PREFIX."payment` WHERE `id` IN (19)");
		...
		$sqlQueryTo[] = "INSERT IGNORE INTO `".PREFIX."setting` (`option`, `value`, `active`, `name`) VALUES ('requiredFields', 'true', 'Y', 'REQUIRED_FIELDS')";
...
if (DatoBaseUpdater::check("8.3.0")) {
	...
	if(NULL_OLD_PRICE == 'NULL_OLD_PRICE') {
		$str = "\r\n";

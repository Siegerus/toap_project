...
class Page {
  ...
  public function updatePage($array) {
    ...
    if($array['parent_url'] !== $currentPage['parent_url'] && $isSystem){
      ...
      foreach ($gategoryArr as $page) {
        ...
        if ($page['parent'] == 0) {
          ...
          if ($newColumn == true) {
            ...
            if ($i > 0) {
              $i = 0;
              $print.= "</div><div class='footer-column'>";
            } else {
              $i = 0;
              $print.= "<div class='footer-column'>";
            }
          }
          ...
          if ($page['invisible'] != 1) {
            ...
            if ($hotFix1) {
              $print.= '<div><a href="'.SITE.'"><span '.$active.'>'.$page['title'].'</span></a></div>';
            } else {
              $print.= '<div><a href="'.$url.'"><span '.$active.'>'.$page['title'].'</span></a></div>';
            }
          }
        }
      }

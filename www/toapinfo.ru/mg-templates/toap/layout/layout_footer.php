    ...
    <div class="footer__cont">
        <div class="footer__cont-contacts">
          <div class="footer-section fs1">
            <h3>
              Таврическое объединение аналитических психологов и психоаналитиков
            </h3>
            <div class="social-icons">
              ...
              <a href="https://ok.ru" aria-label="Odnoklassniki" target="_blank">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <div class="footer-section fs2">
            <h3>Меню</h3>
            <div>
                <?php $res = MG::get('pages')->getFooterPagesUl(); ?>
                <?php echo str_replace(SITE.'/'.SITE, SITE, $res); ?> 
            </div>
          </div>
          ...
          <div class="footer-section fs4">
            <h3>Контакты</h3>
            <?php
              $shopPhone = MG::get('settings')['shopPhone'] ?? '';
              $telLink = htmlspecialchars(str_replace(' ', '', $shopPhone));
              echo '<a href="tel:' . $telLink . '">' . htmlspecialchars($shopPhone) . '</a>';
            ?>
          </div>
        </div>

<?php
mgAddMeta('components/menu/libs/jquery.hoverIntent.js');
mgAddMeta('components/menu/categories/categories.js');
mgAddMeta('components/menu/categories/categories.css');
?>
        ...
        <div class="c-nav__menu">
            <ul class="c-nav__dropdown c-nav__dropdown--1 c-catalog__dropdown c-catalog__dropdown--1">
              ...
              <?php foreach ($data as $category): ?>
                ...
                <?php if (stristr($category['link'], 'kinoklub' !== FALSE) {
                  $category['link'] = str_replace('kinoklub', 'proekt-kinoklub', $category['link']);
                } ?>
                ...
                <?php if (isset($category['child'])): ?>
                  ...
                  if ($noUl) {
                    $slider = '';
                      ...
                      <li class="c-nav__level <?php echo $noUl ? '' : 'c-nav__level_has-sub'; ?> c-nav__level--1 c-catalog__level c-catalog__level--1 c-catalog__level--arrow">
                            ...
                            <?php if (!empty($category['menu_icon'])): ?>
                                <div class="c-nav__img c-catalog__img">
                                    <img src="<?php echo SITE . $category['menu_icon']; ?>"
                                         alt="<?php echo $category['menu_seo_alt']; ?>"
                                         title="<?php echo $category['menu_seo_title']; ?>">
                                </div>
                            <?php endif; ?>
                        ...
                        <?php if ($noUl) {
                          ...
                          <ul class="c-nav__dropdown c-nav__dropdown--2 c-catalog__dropdown c-catalog__dropdown--2">
                            ...
                            <?php foreach ($category['child'] as $categoryLevel1): ?><?php if ($categoryLevel1['invisible'] == "1") {
                              continue;
                            } ?>
                                          ...
                                          <?php if (!empty($categoryLevel1['menu_icon'])): ?>
                                              <div class="mg-cat-img">
                                                  <img src="<?php echo SITE . $categoryLevel1['menu_icon']; ?>"
                                                       alt="<?php echo $categoryLevel1['menu_seo_alt']; ?>"
                                                       title="<?php echo $categoryLevel1['menu_seo_title']; ?>">
                                              </div>
                                          <?php endif; ?>
                                            <div class="c-nav__text c-catalog__text">
                                                        ...
                                                        <?php if (!empty($categoryLevel2['menu_icon'])): ?>
                                                            <div class="mg-cat-img">
                                                                <img src="<?php echo SITE . $categoryLevel2['menu_icon']; ?>"
                                                                     alt="<?php echo $categoryLevel2['menu_seo_alt']; ?>"
                                                                     title="<?php echo $categoryLevel2['menu_seo_title']; ?>">
                                                            </div>
                                                        <?php endif; ?>
                                                          <div class="c-nav__text c-catalog__text">

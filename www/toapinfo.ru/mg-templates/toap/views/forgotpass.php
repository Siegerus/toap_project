...
<div class=" login__container">
    ...
    <?php switch ($data['form']) { case 1: ?>
        ...
        <div class="l-col min-0--12">
            <div class="c-alert c-alert--blue"><?= (edition())?lang('forgotInstruction'):lang('forgotInstructionSms'); ?></div>
        </div>
        <div class="l-col min-0--12">
            <form class="c-form c-form--width" action="<?php echo SITE ?>/forgotpass" method="POST">
                <div class="c-form__row">
                    <input type="text" name="email" placeholder="E-mail <?= (edition())?'':'или '.lang('lphone'); ?>" required>
                </div>
                <div class="c-form__row">

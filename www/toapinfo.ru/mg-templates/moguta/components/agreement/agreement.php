...
<section class="agreement">
    ...
    <dialog class="agreement__modal js-agreement-modal">
        ...
        <?php else: ?>
            ...
            Настоящим, я (далее – Лицо), даю свое согласие на обработку своих персональных данных, указанных
            при
            оформлении заказа на сайте Компании для обработки моего заказа, коммуникации со мной в рамках обработки моего
            заказа, доставки заказанной мной услуги, а также иных сопряженных с этим целей в рамках действующего
            ...
            данные Лица могут передаваться внутри группы лиц, включая трансграничную передачу.
            Настоящее
